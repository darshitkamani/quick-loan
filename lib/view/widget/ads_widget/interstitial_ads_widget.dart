...
class InterstitialAdsWidgetProvider extends ChangeNotifier {
  showFbOrAdxOrAdmobInterstitialAd(String routeName, BuildContext context,
      {required List<String> availableAds,
      required String? googleInterID,
      required String? fbInterID,
    ...
    if (isCheckScreenForAdInApp) {
      if (myAdsIdClass.isFacebook && isFacebookAdsShow) {
        ...
        getRoute(routeName, loanType ?? '', context, arguments,
  ...
  void loadAdxInterstitialAd(
      {required String? googleInterID,
      required String? fbInterID,
      required String screenName,
      required MyAdsIdClass myAdsIdClass,
      BuildContext? context}) {
    String interstitialAdId = kDebugMode
        ...
        adLoadCallback: InterstitialAdLoadCallback(
          onAdLoaded: (ad) {
            ...
            if (screenName == 'Dashboard') {
              showAdxInterstitialAd('POP', context!,
                  googleInterID: googleInterID,
                  fbInterID: fbInterID,
                  myAdsIdClass: myAdsIdClass);
            }
  ...
  showAdxInterstitialAd(String routeName, BuildContext context,
      {String? loanType = '',
      bool isFreeAds = false,
      var arguments,
      required MyAdsIdClass myAdsIdClass,
      required String? googleInterID,
      required String? fbInterID}) async {
    bool isShowAds =
        StorageUtils.prefs.getBool(StorageKeyUtils.isAddShowInApp) ?? false;

    if (isShowAds == false) {
      getRoute(routeName, loanType ?? '', context, arguments,
          isFrom: AdsType.admob,
          googleID: googleInterID,
          fbID: fbInterID,
          myAdsIdClass: myAdsIdClass);
      return;
    ...
    _firstAdxInterstitialAd!.fullScreenContentCallback =
  ...
  Future<void> loadFBInterstitialAd(
    ...
    FacebookInterstitialAd.loadInterstitialAd(
        ...
        listener: (result, value) {
          ...
          if (result == InterstitialAdResult.ERROR) {
            ...
            FacebookInterstitialAd.destroyInterstitialAd();
            StorageUtils.prefs
                .setBool(StorageKeyUtils.isShowFacebookAds, false);
            ...
            StorageUtils.prefs.setBool(
                '${StorageKeyUtils.isFailedTwiceToLoadFbAdId}$fbID', true);
  ...
  showFBInterstitialAd(String routeName, BuildContext context,
      {String? loanType = '',
      required String? googleInterID,
      required String? fbInterID,
      required MyAdsIdClass myAdsIdClass,
  ...
  getRoute(
    ...
    switch (routeName) {
      ...
      case RouteUtils.loanShortDescriptionScreen:
        Navigator.pushNamed(context, RouteUtils.loanShortDescriptionScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.loanFullDescriptionScreen:
        Navigator.pushNamed(context, RouteUtils.loanFullDescriptionScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.takingLoanReasonScreen:
        Navigator.pushNamed(context, RouteUtils.takingLoanReasonScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.loanApplicationProcess:
        Navigator.pushNamed(context, RouteUtils.loanApplicationProcess)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
          } else {
      ...
      case RouteUtils.investmentDetailsScreen:
        Navigator.pushNamed(context, RouteUtils.investmentDetailsScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.eMILoanCalculatorScreen:
        Navigator.pushNamed(context, RouteUtils.eMILoanCalculatorScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.eligibilityLoanCalculatorScreen:
        Navigator.pushNamed(context, RouteUtils.eligibilityLoanCalculatorScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.dashboardMoreLoansScreen:
        Navigator.pushNamed(context, RouteUtils.dashboardMoreLoansScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.loanApplyScreen:
        Navigator.pushNamed(context, RouteUtils.loanApplyScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.clarificationScreen:
        Navigator.pushNamed(context, RouteUtils.clarificationScreen)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
          } else {
      ...
      case RouteUtils.loanAdvantageScreen:
        Navigator.pushNamed(context, RouteUtils.loanAdvantageScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
      ...
      case RouteUtils.questionAnswerScreen:
        Navigator.pushNamed(context, RouteUtils.questionAnswerScreen,
                arguments: arguments)
            .then((value) {
          if (isFrom == AdsType.admob || isFrom == AdsType.adx) {
            // loadInterstitialAd();
